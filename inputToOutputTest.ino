...
const boolean button_one[] = { true, false, false, false, false, false };
const boolean button_two[] = { false, true, false, false, false, false };
const boolean button_three[] = { false, false, true, false, false, false };
const boolean button_four[] = { false, false, false, true, false, false };
const boolean button_five[] = { false, false, false, false, true, false };
const boolean button_six[] = { false, false, false, false, false, true };
...
void writeChr(const boolean *chr,int magnitude)
...
void turnOnChr(const boolean *chr) {
  float magnitude = .5;
  writeChr(chr,(int)(255 * magnitude));
}

void writeChr(const boolean *chr,int magnitude){
  if (chr[0]) analogWrite(VIBE_ZERO, magnitude);
  if (chr[1]) analogWrite(VIBE_ONE, magnitude);
  if (chr[2]) analogWrite(VIBE_TWO, magnitude);
  if (chr[3]) analogWrite(VIBE_THREE, magnitude);
  if (chr[4]) analogWrite(VIBE_FOUR, magnitude);
  if (chr[5]) analogWrite(VIBE_FIVE, magnitude);
}
